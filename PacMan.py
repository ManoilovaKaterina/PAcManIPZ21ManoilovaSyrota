...
NameFont = 'C:/Users/undor/sprites/8_bit_arcade/8-bit Arcade Out.ttf'
NameFontIn = 'C:/Users/undor/sprites/8_bit_arcade/8-bit Arcade In.ttf'
...
def MainMenu():
    ...
    while menu:
        ...
        screen.blit(ImageFormat(GhostColors[3]), (screen_width-65, screen_height-110))
        ...
        if Choose == "menu":
            ...
            if selected=="normal":
                text_normal=TextFormat("NORMAL", font, 30, white)
            else:
                text_normal = TextFormat("NORMAL", font, 30, yellow)
            ...
            screen.blit(text_normal, (screen_width/2 - (normal_rect[2]/2), 380))
